/////////////////////////////////////////////////////////////////////////////////
// File: VCSMiscellaneous.cpp
//
// Generated by : thomas askew
// Generation date : 11:00:00 20/01/2003
//
...
Module Title        : VCSMiscellaneous.cpp
...
---------------------
$Revision: 4 $
$Date: 11/08/04 11:34a $
$Author: R.fraser $
$Workfile: VCSMiscellaneous.cpp $
------------------------------------------------------------------------------
  ...
  public class Miscellaneous
    {
     ...
     public bool DetectStatusChange(const char pInputData, bool bGoodVcsControlStatus, bool bGoodVcsNodeStatus)
{

    bool reply = false;
        int byte, max_byte_count;
...
public void ClearMsgQueue(const int VIC_ExNo)
{
...
char szTemp[5];
     ...
     _ftime( &tExtTime );
tTime = gmtime(&tExtTime.time);

   sprintf(szTimeStr, "%d_%d%_%d %d_%d_%d_",
                                    tTime->tm_mday,
                                    tTime->tm_mon + 1,
                                    tTime->tm_year + 1900,
                                    tTime->tm_hour,
