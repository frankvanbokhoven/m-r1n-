/////////////////////////////////////////////////////////////////////////////////
// File: VCSInterfaceManagement.cpp
//
...
Module Title        : VCSInterfaceMAnagement.cpp
...
$Date: 12/04/05 3:06p $
$Author: R.fraser $
$Workfile: VCSInterfaceMangement.cpp $
------------------------------------------------------------------------------
   ...
   public class InterfaceManagement
    {
        ...
        void CCommsComponent::ConnectToVCS(void* pOwner)
        {
            ...
            /* Use this code if wanting to bind this client to a specific address & port number */
            /* Bind socket to required client adddress x/
            /* Need cable installed or get WSAEADDRNOTAVAIL x/
            serverAddr.sin_addr.s_addr = inet_addr(CLIENT_ADDRESS); //converts dotted IP address to a number
            ...
            {
                nWSAErrorCode = pCommsComp->GetWSAError(WSAGetLastError ());
                closesocket(clientSocket);
                pCommsComp->m_tVcsIfManage.eVCS_LinkState = FAILED_CONNECT;
                return;
            }
            */
