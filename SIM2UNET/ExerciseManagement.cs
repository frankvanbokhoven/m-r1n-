...
namespace SIM2UNET
{
   public class ExerciseManagement
    ...
    const char szModeStr[8] = { "UNKNOWN", "STT-SINGLE", "STT-MULTI", "IL", "RAD ONLY", "UNKNOWN", "UNKNOWN", "UNKNOWN" };
  ...
  public long ResetVCS()
    {
        ...
        newMsg->sMsgExpectedReply = A_SC_RESET;
  ...
  public  bool SetSttExercise(msgVCSCommunicationSTTConfirmation_t pED)
    {
        ...
        {
            memcpy((void*)m_pVcsExManage[VIC_ExNo].Radio[RoleIdx].szFrequency,
                            (void*)pED->RadioData[RoleIdx].szFrequency,
                            sizeof(m_pVcsExManage[VIC_ExNo].Radio[RoleIdx].szFrequency));

        memcpy((void*)m_pVcsExManage[VIC_ExNo].Radio[RoleIdx].szStation,
                        (void*)pED->RadioData[RoleIdx].szStation,
                        sizeof(pED->RadioData[RoleIdx].szStation));

        m_pVcsExManage[VIC_ExNo].Radio[RoleIdx].sType = (short)pED->RadioData[RoleIdx].nType;
...
public void SetTestExercise(const int TEST_ExNo)
{
    int n, nTraineeIdx;
...
public bool DefineVcsExercise(const int VIC_ExNo)
{
    QueuedMsg_t newMsg;

    char szPointDAAddress[] = "ADDR [500000][1] ";
    char szCabinDAAddress[] = "ADDR [1111][1] ";
    const char* szRadioType[] = { "HF", "UHF" };
    char szTemp[25];
    char pcData;
...
public bool AllocVcsExercise(const int VIC_ExNo)
{
...
public bool StartVcsExercise(const int VIC_ExNo)
{
    ...
    switch (m_pVcsExManage[VIC_ExNo].eLoadType)
    {
        ...
        case EXERCISE_RECOVERY: // no longer utilised
            ...
            newMsg->MsgHeader.sID = (USHORT)I_EC_START;
...
public bool ResumeVcsExercise(const int VIC_ExNo)
{
